...
description: "Add Veritrix to your Python project in under a minute by installing directly from the veritrix-ai/veritrix-sdk GitHub repository. Requires Python 3.8 or later."
---
...
```bash poetry
poetry add git+https://github.com/veritrix-ai/veritrix-sdk.git
```

</CodeGroup>

<Note>
  The SDK is installed directly from the [veritrix-ai/veritrix-sdk](https://github.com/veritrix-ai/veritrix-sdk) GitHub repository.
</Note>
...
<Tip>
  The recommended way to supply your API key is through the `VERITRIX_API_KEY` environment variable so it never appears in source code. See the [Initialization](/sdk/initialization) page for details.
</Tip>
